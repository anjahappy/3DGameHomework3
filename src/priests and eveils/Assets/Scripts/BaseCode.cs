...
namespace Com.Mygame {
	...
	public class CoastController {
		...
		readonly Vector3 from_pos = new Vector3(3.5f,0.2f,0);
		readonly Vector3 to_pos = new Vector3(-3.5f,0.2f,0);
		...
		public CoastController(string _to_or_from) {
			positions = new Vector3[] {new Vector3(2.8f,0.8F,0), new Vector3(3.1F,0.8F,0), new Vector3(3.4F,0.8F,0), 
				new Vector3(3.7F,0.8F,0), new Vector3(4.0F,0.8F,0), new Vector3(4.3F,0.8F,0)};
	...
	public class BoatController {
		...
		readonly Moveable moveableScript;
		readonly Vector3 fromPosition = new Vector3 (2, 0.3f, 0);
		readonly Vector3 toPosition = new Vector3 (-2, 0.3f, 0);
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (1.8F, 0.4F, 0), new Vector3 (2.2F, 0.4F, 0) };
			to_positions = new Vector3[] { new Vector3 (-1.8F, 0.4F, 0), new Vector3 (-2.2F, 0.4F, 0) };
